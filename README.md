...
The data is sourced from Sonatype Nexus Lifecycle's IQ Server, which accesses the Sonatype Data Services for those supported ecosystems. Some systems get their data from Sonatype OSSIndex ( https://ossindex.sonatype.org/ ).
